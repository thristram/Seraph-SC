  ...
  91                     ; 50 	sc.slc[0].deviceid[0] = 0xAA;
  93  0015 35aa01bf      	mov	_sc+447,#170
  94                     ; 51 	sc.slc[0].deviceid[1] = 0x55;
  96  0019 355501c0      	mov	_sc+448,#85
  97                     ; 52 	sc.slc[0].deviceid[2] = 0xAB;
  99  001d 35ab01c1      	mov	_sc+449,#171
 100                     ; 53 	sc.slc[0].deviceid[3] = 0x57;
 102  0021 355701c2      	mov	_sc+450,#87
 103                     ; 54 	sc.spc[1].deviceid[0] = 0xAA;
 105  0025 35aa0037      	mov	_sc+55,#170
 106                     ; 55 	sc.spc[1].deviceid[1] = 0x55;
 108  0029 35550038      	mov	_sc+56,#85
 109                     ; 56 	sc.spc[1].deviceid[2] = 0xAB;
 111  002d 35ab0039      	mov	_sc+57,#171
 112                     ; 57 	sc.spc[1].deviceid[3] = 0x58;
 114  0031 3558003a      	mov	_sc+58,#88
 115                     ; 58 	for(i = 0; i < 15; i++){
 117  0035 0f02          	clr	(OFST+0,sp)
 118  0037               L73:
 119                     ; 59 		for(j = 0; j < 4;j++){
 ...
 428                     ; 114 	delay(2500);//等待SLC SPC上电完成初始化。10s
 430  004a ae09c4        	ldw	x,#2500
 431  004d cd0000        	call	_delay
 433  0050               L101:
 434                     ; 117 		if((!init_slc_spc_done)&&(rev_bleheartbeat)){
 ...
 488                     ; 132 					if(ret == IIC_SUCCESS) {
 490  0093 1e03          	ldw	x,(OFST-1,sp)
 491  0095 2621          	jrne	L111
 492                     ; 133 						action_dimmer_MDID = 0x00;
 494  0097 725f0000      	clr	_action_dimmer_MDID
 495                     ; 134 						delay(10);
 497  009b ae000a        	ldw	x,#10
 498  009e cd0000        	call	_delay
 500                     ; 135 						sicp_receipt_Done(0x05,rev_ad_message_id,ns_host_meshid_H,ns_host_meshid_L,0x01,rev_ad_mdid);
 ...
 530                     ; 149 			check_send_repeatedly();
 532  00ca cd0000        	call	_check_send_repeatedly
 534                     ; 150 			report_energy_consum();
 536  00cd cd0000        	call	_report_energy_consum
 538                     ; 151 			if(tick_5s >= 5)	{tick_5s = 0;i2c_heartbeat();}
